            ...
            <div class="menu-section">
                ...
                <div class="menu-items">
                    ...
                    <div id="training" class="submenu">
                        ...
                        <a href="../tc/upload_certificates.php" class="submenu-item">Upload Certificates</a>
                        <a href="../tc/request_training.php" class="submenu-item">Request Training</a>
                        <a href="../tc/view_events.php" class="submenu-item">View Events</a>
                    </div>

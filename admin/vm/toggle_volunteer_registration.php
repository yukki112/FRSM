...
<head>
    ...
    <style>
        ...
        .dark-mode {
            ...
            --icon-bg-red: #7f1d1d;
            --icon-bg-blue: #1e3a8a;
            --icon-bg-green: #064e3b;
            --icon-bg-purple: #5b21b6;
            --icon-bg-yellow: #78350f;
        ...
        /* NEW LAYOUT DESIGN WITHOUT GLASSMORPHISM */
        .dashboard-content {
            padding: 0;
            min-height: 100vh;
        }
                    ...
                    <div class="side-panel">
                        ...
                        <div class="info-card">
                            ...
                            <div style="display: flex; flex-direction: column; gap: 12px;">
                                <a href="review-volunteers.php" class="btn-toggle" style="background: var(--primary-color); text-decoration: none; text-align: center;">
                                    <i class='bx bxs-user-check'></i>
                                    Review Applications
                                </a>
                                <a href="../../index.php" target="_blank" class="btn-toggle" style="background: var(--primary-color); text-decoration: none; text-align: center;">
                                    <i class='bx bx-show'></i>
                                    View Portal
                                </a>
                                <a href="view-availability.php" class="btn-toggle" style="background: var(--primary-color); text-decoration: none; text-align: center;">

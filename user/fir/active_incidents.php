            ...
            <div class="menu-section">
                ...
                <div class="menu-items">
                    ...
                    <div id="volunteer" class="submenu">
                        <a href="../volunteer/volunteer_list.php" class="submenu-item">Volunteer List</a>
                        <a href="../volunteer/roles_skills.php" class="submenu-item">Roles & Skills</a>
                        <a href="../volunteer/availability.php" class="submenu-item">Availability</a>
                    </div>
